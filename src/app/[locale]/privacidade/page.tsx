...
export async function generateMetadata() {
  ...
  for (const locale of routing.locales) {
    languages[locale] = host + (await getPathname({ locale, href: "/privacidade" }));
  }
  ...
  return {
    ...
    alternates: { canonical: host + "/privacidade", languages },
...
export default function PrivacidadePage() {
  return (
    <LegalPageShell otherLegalHref="/termos" otherLegalLabelKey="navTerms">
